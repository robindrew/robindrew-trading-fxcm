...
public class FxcmPriceTickDownloader {
	...
	public static void main(String[] args) {
		...
		for (String instrument : AVAILABLE_INSTRUMENTS) {
			FxcmPriceTickDownloader downloader = new FxcmPriceTickDownloader(instrument);
	...
	public FxcmPriceTickDownloader(String instrument) {
